            ...
            <div class="relative w-full max-w-lg bg-[#0b1220]/95 rounded-2xl shadow-2xl ring-1 ring-white/15 overflow-hidden">
                ...
                <form method="POST" enctype="multipart/form-data" :action="action()" class="p-6 space-y-4">
                    ...
                    <div x-data="{ selectedMovie: @json($selectedMovie) }">
                        ...
                        <select id="movie_title" name="movie_title" x-model="selectedMovie" class="mt-1 block w-full rounded-xl bg-[#111827] border border-white/10 text-white focus:border-yellow-400 focus:ring-yellow-400 shadow-sm hover:border-white/20 transition" required>
